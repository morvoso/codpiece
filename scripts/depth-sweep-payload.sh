...
# at temperature 1.0; tandem always drafts K and reports 0.35-0.42. Under the rejection
...
#
# Sweep it on the box's own benchmark, at the depth where tandem trails.
set -u
