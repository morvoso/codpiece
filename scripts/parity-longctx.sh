...
# prompts touch. Compares codpiece vs llama-completion (b10423), greedy.
#
...
CORPUS=${CORPUS:-$HOME/llm/codpiece/wiki.test.raw}
NPROMPT=${1:-2000}
NGEN=${2:-32}
...
O=$(docker run --rm --runtime nvidia \
      ...
      -v "$HOME/llm/codpiece:/work" -v "$HOME/llm/models:/models" -v /tmp:/host-tmp \
