...
//! struct layout, and the backend API surface codpiece-runtime will use.

use codpiece_ggml_sys::*;
...
fn vendored_ops_present() {
    // The two ops codpiece's qwen35 graph cannot live without. Their presence at
